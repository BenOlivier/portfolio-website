var $jscomp=$jscomp||{}; $jscomp.scope={}; $jscomp.arrayIteratorImpl=function(f) { let m=0; return function() { return m<f.length?{done: !1, value: f[m++]}:{done: !0}; }; }; $jscomp.arrayIterator=function(f) { return {next: $jscomp.arrayIteratorImpl(f)}; }; $jscomp.makeIterator=function(f) { const m='undefined'!=typeof Symbol&&Symbol.iterator&&f[Symbol.iterator]; return m?m.call(f):$jscomp.arrayIterator(f); };
...
$jscomp.polyfill=function(f, m, v, t) { if (m) { v=$jscomp.global; f=f.split('.'); for (t=0; t<f.length-1; t++) { const h=f[t]; h in v||(v[h]={}); v=v[h]; }f=f[f.length-1]; t=v[f]; m=m(t); m!=t&&null!=m&&$jscomp.defineProperty(v, f, {configurable: !0, writable: !0, value: m}); } }; $jscomp.FORCE_POLYFILL_PROMISE=!1;
$jscomp.polyfill('Promise', function(f)
{
function m() { this.batch_=null; } function v(e) { return e instanceof h?e:new h(function(l, f) { l(e); }); } if (f&&!$jscomp.FORCE_POLYFILL_PROMISE) return f; m.prototype.asyncExecute=function(e) { if (null==this.batch_) { this.batch_=[]; const l=this; this.asyncExecuteFunction(function() { l.executeBatch_(); }); } this.batch_.push(e); }; const t=$jscomp.global.setTimeout; m.prototype.asyncExecuteFunction=function(e) { t(e, 0); }; m.prototype.executeBatch_=function()
{
...
}; m.prototype.asyncThrow_=function(e) { this.asyncExecuteFunction(function() { throw e; }); }; var h=function(e)
{
...
catch (S) { this.reject_(S); return; }'function'==typeof l?
this.settleSameAsThenable_(l, e):this.fulfill_(e);
}; h.prototype.reject_=function(e) { this.settle_(2, e); }; h.prototype.fulfill_=function(e) { this.settle_(1, e); }; h.prototype.settle_=function(e, l) { if (0!=this.state_) throw Error('Cannot settle('+e+', '+l+'): Promise already settled in state'+this.state_); this.state_=e; this.result_=l; this.executeOnSettledCallbacks_(); }; h.prototype.executeOnSettledCallbacks_=function()
{
...
}; h.all=function(e) { const f=$jscomp.makeIterator(e); let m=f.next(); return m.done?v([]):new h(function(e, h) { function l(f) { return function(h) { t[f]=h; z--; 0==z&&e(t); }; } var t=[]; var z=0; do t.push(void 0), z++, v(m.value).callWhenSettled_(l(t.length-1), h), m=f.next(); while (!m.done); }); }; return h;
}, 'es6', 'es3');
const DracoDecoderModule=function()
{
let f='undefined'!==typeof document&&document.currentScript?document.currentScript.src:void 0; 'undefined'!==typeof __filename&&(f=f||__filename); return function(m)
{
function v(k) { return a.locateFile?a.locateFile(k, M):M+k; } function t(a, c) { a||z('Assertion failed: '+c); } function h(a, c, b)
{
let d=c+b; for (b=c; a[b]&&!(b>=d);)++b; if (16<b-c&&a.subarray&&xa) return xa.decode(a.subarray(c, b)); for (d=''; c<b;)
{
let k=a[c++]; if (k&128)
{
const e=a[c++]&63; if (192==(k&224))
{
d+=String.fromCharCode((k&
31)<<6|e);
}
else { const f=a[c++]&63; k=224==(k&240)?(k&15)<<12|e<<6|f:(k&7)<<18|e<<12|f<<6|a[c++]&63; 65536>k?d+=String.fromCharCode(k):(k-=65536, d+=String.fromCharCode(55296|k>>10, 56320|k&1023)); }
}
else d+=String.fromCharCode(k);
} return d;
} function X(a, c) { return a?h(ca, a, c):''; } function e(a, c) { 0<a%c&&(a+=c-a%c); return a; } function l(k)
{
...
} function Ma() { return da||!ea&&!Z||'function'!==typeof fetch?new Promise(function(a, c) { a(wa()); }):fetch(U, {credentials: 'same-origin'}).then(function(a) { if (!a.ok) throw 'failed to load wasm binary file at \''+U+'\''; return a.arrayBuffer(); }).catch(function() { return wa(); }); } function ba()
{
if (!ba.strings)
{
const a={USER: 'web_user',
LOGNAME: 'web_user', PATH: '/', PWD: '/', HOME: '/home/web_user', LANG: ('object'===typeof navigator&&navigator.languages&&navigator.languages[0]||'C').replace('-', '_')+'.UTF-8', _: na}; let c; for (c in Aa)a[c]=Aa[c]; const b=[]; for (c in a)b.push(c+'='+a[c]); ba.strings=b;
} return ba.strings;
} function ma(k)
{
function c()
...
} if (!(0<aa)) { if (a.preRun) for ('function'==typeof a.preRun&&(a.preRun=[a.preRun]); a.preRun.length;)Fa.unshift(a.preRun.shift()); S(Fa); 0<aa||(a.setStatus?(a.setStatus('Running...'), setTimeout(function() { setTimeout(function() { a.setStatus(''); }, 1); c(); }, 1)):c()); }
...
{
let e=a.charCodeAt(k); if (55296<=e&&57343>=e) { const f=a.charCodeAt(++k); e=65536+((e&1023)<<10)|f&1023; } if (127>=e) { if (b>=d) break; c[b++]=e; }
else
{
if (2047>=e) { if (b+1>=d) break; c[b++]=192|e>>6; }
else
{
 if (65535>=e) { if (b+2>=d) break; c[b++]=224|e>>12; }
...
this;
}m=m||{}; var a='undefined'!==typeof m?m:{}; let Ga=!1; let Ha=!1; a.onRuntimeInitialized=function() { Ga=!0; if (Ha&&'function'===typeof a.onModuleLoaded)a.onModuleLoaded(a); }; a.onModuleParsed=function() { Ha=!0; if (Ga&&'function'===typeof a.onModuleLoaded)a.onModuleLoaded(a); }; a.isVersionSupported=function(a) { if ('string'!==typeof a) return !1; a=a.split('.'); return 2>a.length||3<a.length?!1:1==a[0]&&0<=a[1]&&3>=a[1]?!0:0!=a[0]||10<a[1]?!1:!0; }; let ha={}; let W; for (W in a)a.hasOwnProperty(W)&&(ha[W]=a[W]); var na='./this.program';
var ea=!1; var Z=!1; let oa=!1; let fb=!1; let Ia=!1; ea='object'===typeof window; Z='function'===typeof importScripts; oa=(fb='object'===typeof process&&'object'===typeof process.versions&&'string'===typeof process.versions.node)&&!ea&&!Z; Ia=!ea&&!oa&&!Z; var M=''; let pa; let qa; if (oa)
{
M=__dirname+'/'; var ra=function(a, c) { pa||(pa=require('fs')); qa||(qa=require('path')); a=qa.normalize(a); return pa.readFileSync(a, c?null:'utf8'); }; var la=function(a) { a=ra(a, !0); a.buffer||(a=new Uint8Array(a)); t(a.buffer); return a; }; 1<process.argv.length&&
(na=process.argv[1].replace(/\\/g, '/')); process.argv.slice(2); process.on('uncaughtException', function(a) { throw a; }); process.on('unhandledRejection', z); a.inspect=function() { return '[Emscripten Module object]'; };
}
else if (Ia)
{
'undefined'!=typeof read&&(ra=function(a) { return read(a); }), la=function(a) { if ('function'===typeof readbuffer) return new Uint8Array(readbuffer(a)); a=read(a, 'binary'); t('object'===typeof a); return a; }, 'undefined'!==typeof print&&('undefined'===typeof console&&(console={}), console.log=print,
console.warn=console.error='undefined'!==typeof printErr?printErr:print);
}
 else if (ea||Z)Z?M=self.location.href:document.currentScript&&(M=document.currentScript.src), f&&(M=f), M=0!==M.indexOf('blob:')?M.substr(0, M.lastIndexOf('/')+1):'', ra=function(a) { const c=new XMLHttpRequest; c.open('GET', a, !1); c.send(null); return c.responseText; }, Z&&(la=function(a) { const c=new XMLHttpRequest; c.open('GET', a, !1); c.responseType='arraybuffer'; c.send(null); return new Uint8Array(c.response); }); var ya=a.print||console.log.bind(console);
var Y=a.printErr||console.warn.bind(console); for (W in ha)ha.hasOwnProperty(W)&&(a[W]=ha[W]); ha=null; a.thisProgram&&(na=a.thisProgram); let da; a.wasmBinary&&(da=a.wasmBinary); 'object'!==typeof WebAssembly&&Y('no native wasm support detected'); let ia; const gb=new WebAssembly.Table({initial: 293, maximum: 293, element: 'anyfunc'}); var za=!1; var xa='undefined'!==typeof TextDecoder?new TextDecoder('utf8'):void 0; 'undefined'!==typeof TextDecoder&&new TextDecoder('utf-16le'); let T; let ca; let P; let Ja=a.TOTAL_MEMORY||16777216; if (ia=a.wasmMemory?
a.wasmMemory:new WebAssembly.Memory({initial: Ja/65536})) var ka=ia.buffer; Ja=ka.byteLength; l(ka); P[3416]=5256704; var Fa=[]; var Ca=[]; var Da=[]; var Ea=[]; var Ba=!1; var aa=0; let sa=null; let ja=null; a.preloadedImages={}; a.preloadedAudios={}; var U='draco_decoder.wasm'; va(U)||(U=v(U)); Ca.push({func: function() { hb(); }}); var Aa={}; var R={buffers: [null, [], []], printChar: function(a, c) { const b=R.buffers[a]; 0===c||10===c?((1===a?ya:Y)(h(b, 0)), b.length=0):b.push(c); }, varargs: 0, get: function(a) { R.varargs+=4; return P[R.varargs-4>>2]; }, getStr: function() { return X(R.get()); },
get64: function() { const a=R.get(); R.get(); return a; }, getZero: function() { R.get(); }}; const Ka={__cxa_allocate_exception: function(a) { return ib(a); }, __cxa_throw: function(a, c, b) { 'uncaught_exception'in ta?ta.uncaught_exceptions++:ta.uncaught_exceptions=1; throw a; }, abort: function() { z(); }, emscripten_get_sbrk_ptr: function() { return 13664; }, emscripten_memcpy_big: function(a, c, b) { ca.set(ca.subarray(c, c+b), a); }, emscripten_resize_heap: function(a)
{
if (2147418112<a) return !1; for (var c=Math.max(T.length, 16777216); c<a;)
{
c=536870912>=
...
}, environ_get: function(a, c) { let b=0; ba().forEach(function(d, e) { let f=c+b; e=P[a+4*e>>2]=f; for (f=0; f<d.length; ++f)T[e++>>0]=d.charCodeAt(f); T[e>>0]=0; b+=d.length+1; }); return 0; }, environ_sizes_get: function(a, c) { const b=ba(); P[a>>2]=b.length; let d=0; b.forEach(function(a) { d+=a.length+1; }); P[c>>2]=d; return 0; }, fd_close: function(a) { return 0; }, fd_seek: function(a,
c, b, d, e) { return 0; }, fd_write: function(a, c, b, d)
{
...
}, memory: ia, setTempRet0: function(a) {}, table: gb}; const La=function()
{
function e(c, b) { a.asm=c.exports; aa--; a.monitorRunDependencies&&a.monitorRunDependencies(aa); 0==aa&&(null!==sa&&(clearInterval(sa), sa=null), ja&&(c=ja, ja=null, c())); } function c(a) { e(a.instance); }
function b(a) { return Ma().then(function(a) { return WebAssembly.instantiate(a, d); }).then(a, function(a) { Y('failed to asynchronously prepare wasm: '+a); z(a); }); } var d={env: Ka, wasi_unstable: Ka}; aa++; a.monitorRunDependencies&&a.monitorRunDependencies(aa); if (a.instantiateWasm)
{
try { return a.instantiateWasm(d, e); }
catch (Na) { return Y('Module.instantiateWasm callback failed with error: '+Na), !1; }
}(function()
{
if (da||'function'!==typeof WebAssembly.instantiateStreaming||va(U)||'function'!==typeof fetch) return b(c); fetch(U,
{credentials: 'same-origin'}).then(function(a) { return WebAssembly.instantiateStreaming(a, d).then(c, function(a) { Y('wasm streaming compile failed: '+a); Y('falling back to ArrayBuffer instantiation'); b(c); }); });
})(); return {};
}(); a.asm=La; var hb=a.___wasm_call_ctors=function() { return a.asm.__wasm_call_ctors.apply(null, arguments); }; const jb=a._emscripten_bind_Status_code_0=function() { return a.asm.emscripten_bind_Status_code_0.apply(null, arguments); }; const kb=a._emscripten_bind_Status_ok_0=function()
{
...
}; ja=function c() { fa||ma(); fa||(ja=c); }; a.run=ma; if (a.preInit) for ('function'==typeof a.preInit&&(a.preInit=[a.preInit]); 0<a.preInit.length;)a.preInit.pop()(); ma(); p.prototype=Object.create(p.prototype); p.prototype.constructor=p; p.prototype.__class__=p; p.__cache__={}; a.WrapperObject=p; a.getCache=u; a.wrapPointer=N; a.castObject=function(a, b) { return N(a.ptr, b); }; a.NULL=N(0); a.destroy=function(a)
{
if (!a.__destroy__) throw 'Error: Cannot destroy object. (Did you create it yourself?)';
a.__destroy__(); delete u(a.__class__)[a.ptr];
}; a.compare=function(a, b) { return a.ptr===b.ptr; }; a.getPointer=function(a) { return a.ptr; }; a.getClass=function(a) { return a.__class__; }; var n={buffer: 0, size: 0, pos: 0, temps: [], needed: 0, prepare: function() { if (n.needed) { for (let c=0; c<n.temps.length; c++)a._free(n.temps[c]); n.temps.length=0; a._free(n.buffer); n.buffer=0; n.size+=n.needed; n.needed=0; }n.buffer||(n.size+=128, n.buffer=a._malloc(n.size), t(n.buffer)); n.pos=0; }, alloc: function(c, b)
{
...
x.prototype.error_msg=function() { return X(lb(this.ptr)); }; x.prototype.__destroy__=x.prototype.__destroy__=function() { mb(this.ptr); }; A.prototype=Object.create(p.prototype); A.prototype.constructor=A; A.prototype.__class__=A; A.__cache__={}; a.DracoUInt16Array=A; A.prototype.GetValue=A.prototype.GetValue=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return nb(c, a); }; A.prototype.size=A.prototype.size=function() { return ob(this.ptr); }; A.prototype.__destroy__=A.prototype.__destroy__=function() { pb(this.ptr); };
...
C.prototype.GetValue=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return tb(c, a); }; C.prototype.size=C.prototype.size=function() { return ub(this.ptr); }; C.prototype.__destroy__=C.prototype.__destroy__=function() { vb(this.ptr); }; D.prototype=Object.create(p.prototype); D.prototype.constructor=D; D.prototype.__class__=D; D.__cache__={}; a.DracoUInt32Array=D; D.prototype.GetValue=D.prototype.GetValue=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return wb(c, a); }; D.prototype.size=D.prototype.size=
function() { return xb(this.ptr); }; D.prototype.__destroy__=D.prototype.__destroy__=function() { yb(this.ptr); }; E.prototype=Object.create(p.prototype); E.prototype.constructor=E; E.prototype.__class__=E; E.__cache__={}; a.AttributeOctahedronTransform=E; E.prototype.InitFromAttribute=E.prototype.InitFromAttribute=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return !!zb(c, a); }; E.prototype.quantization_bits=E.prototype.quantization_bits=function() { return Ab(this.ptr); }; E.prototype.__destroy__=E.prototype.__destroy__=
...
J; J.prototype.__class__=J; J.__cache__={}; a.AttributeTransformData=J; J.prototype.transform_type=J.prototype.transform_type=function() { return Mb(this.ptr); }; J.prototype.__destroy__=J.prototype.__destroy__=function() { Nb(this.ptr); }; w.prototype=Object.create(p.prototype); w.prototype.constructor=w; w.prototype.__class__=w; w.__cache__={}; a.AttributeQuantizationTransform=w; w.prototype.InitFromAttribute=w.prototype.InitFromAttribute=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return !!Ob(c, a); };
w.prototype.quantization_bits=w.prototype.quantization_bits=function() { return Pb(this.ptr); }; w.prototype.min_value=w.prototype.min_value=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return Qb(c, a); }; w.prototype.range=w.prototype.range=function() { return Rb(this.ptr); }; w.prototype.__destroy__=w.prototype.__destroy__=function() { Sb(this.ptr); }; F.prototype=Object.create(p.prototype); F.prototype.constructor=F; F.prototype.__class__=F; F.__cache__={}; a.DracoInt8Array=F; F.prototype.GetValue=F.prototype.GetValue=
function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return Tb(c, a); }; F.prototype.size=F.prototype.size=function() { return Ub(this.ptr); }; F.prototype.__destroy__=F.prototype.__destroy__=function() { Vb(this.ptr); }; r.prototype=Object.create(p.prototype); r.prototype.constructor=r; r.prototype.__class__=r; r.__cache__={}; a.MetadataQuerier=r; r.prototype.HasEntry=r.prototype.HasEntry=function(a, b)
{
const c=this.ptr; n.prepare(); a&&'object'===typeof a&&(a=a.ptr); b=b&&'object'===typeof b?b.ptr:V(b); return !!Wb(c,
a, b);
}; r.prototype.GetIntEntry=r.prototype.GetIntEntry=function(a, b) { const c=this.ptr; n.prepare(); a&&'object'===typeof a&&(a=a.ptr); b=b&&'object'===typeof b?b.ptr:V(b); return Xb(c, a, b); }; r.prototype.GetIntEntryArray=r.prototype.GetIntEntryArray=function(a, b, d) { const c=this.ptr; n.prepare(); a&&'object'===typeof a&&(a=a.ptr); b=b&&'object'===typeof b?b.ptr:V(b); d&&'object'===typeof d&&(d=d.ptr); Yb(c, a, b, d); }; r.prototype.GetDoubleEntry=r.prototype.GetDoubleEntry=function(a, b)
{
const c=this.ptr; n.prepare(); a&&'object'===
typeof a&&(a=a.ptr); b=b&&'object'===typeof b?b.ptr:V(b); return Zb(c, a, b);
}; r.prototype.GetStringEntry=r.prototype.GetStringEntry=function(a, b) { const c=this.ptr; n.prepare(); a&&'object'===typeof a&&(a=a.ptr); b=b&&'object'===typeof b?b.ptr:V(b); return X($b(c, a, b)); }; r.prototype.NumEntries=r.prototype.NumEntries=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return ac(c, a); }; r.prototype.GetEntryName=r.prototype.GetEntryName=function(a, b)
{
const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===
typeof b&&(b=b.ptr); return X(bc(c, a, b));
}; r.prototype.__destroy__=r.prototype.__destroy__=function() { cc(this.ptr); }; G.prototype=Object.create(p.prototype); G.prototype.constructor=G; G.prototype.__class__=G; G.__cache__={}; a.DracoInt16Array=G; G.prototype.GetValue=G.prototype.GetValue=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return dc(c, a); }; G.prototype.size=G.prototype.size=function() { return ec(this.ptr); }; G.prototype.__destroy__=G.prototype.__destroy__=function() { fc(this.ptr); }; H.prototype=
Object.create(p.prototype); H.prototype.constructor=H; H.prototype.__class__=H; H.__cache__={}; a.DracoFloat32Array=H; H.prototype.GetValue=H.prototype.GetValue=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return gc(c, a); }; H.prototype.size=H.prototype.size=function() { return hc(this.ptr); }; H.prototype.__destroy__=H.prototype.__destroy__=function() { ic(this.ptr); }; O.prototype=Object.create(p.prototype); O.prototype.constructor=O; O.prototype.__class__=O; O.__cache__={}; a.GeometryAttribute=O; O.prototype.__destroy__=
O.prototype.__destroy__=function() { jc(this.ptr); }; K.prototype=Object.create(p.prototype); K.prototype.constructor=K; K.prototype.__class__=K; K.__cache__={}; a.DecoderBuffer=K; K.prototype.Init=K.prototype.Init=function(a, b) { const c=this.ptr; n.prepare(); if ('object'==typeof a&&'object'===typeof a) { const e=n.alloc(a, T); n.copy(a, T, e); a=e; }b&&'object'===typeof b&&(b=b.ptr); kc(c, a, b); }; K.prototype.__destroy__=K.prototype.__destroy__=function() { lc(this.ptr); }; g.prototype=Object.create(p.prototype); g.prototype.constructor=
g; g.prototype.__class__=g; g.__cache__={}; a.Decoder=g; g.prototype.GetEncodedGeometryType=g.prototype.GetEncodedGeometryType=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return mc(c, a); }; g.prototype.DecodeBufferToPointCloud=g.prototype.DecodeBufferToPointCloud=function(a, b) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); return N(nc(c, a, b), x); }; g.prototype.DecodeBufferToMesh=g.prototype.DecodeBufferToMesh=function(a, b)
{
const c=this.ptr; a&&'object'===typeof a&&
(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); return N(oc(c, a, b), x);
}; g.prototype.GetAttributeId=g.prototype.GetAttributeId=function(a, b) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); return pc(c, a, b); }; g.prototype.GetAttributeIdByName=g.prototype.GetAttributeIdByName=function(a, b) { const c=this.ptr; n.prepare(); a&&'object'===typeof a&&(a=a.ptr); b=b&&'object'===typeof b?b.ptr:V(b); return qc(c, a, b); }; g.prototype.GetAttributeIdByMetadataEntry=g.prototype.GetAttributeIdByMetadataEntry=
function(a, b, d) { const c=this.ptr; n.prepare(); a&&'object'===typeof a&&(a=a.ptr); b=b&&'object'===typeof b?b.ptr:V(b); d=d&&'object'===typeof d?d.ptr:V(d); return rc(c, a, b, d); }; g.prototype.GetAttribute=g.prototype.GetAttribute=function(a, b) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); return N(sc(c, a, b), q); }; g.prototype.GetAttributeByUniqueId=g.prototype.GetAttributeByUniqueId=function(a, b)
{
const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr);
return N(tc(c, a, b), q);
}; g.prototype.GetMetadata=g.prototype.GetMetadata=function(a) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); return N(uc(c, a), L); }; g.prototype.GetAttributeMetadata=g.prototype.GetAttributeMetadata=function(a, b) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); return N(vc(c, a, b), L); }; g.prototype.GetFaceFromMesh=g.prototype.GetFaceFromMesh=function(a, b, d)
{
const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===
typeof d&&(d=d.ptr); return !!wc(c, a, b, d);
}; g.prototype.GetTriangleStripsFromMesh=g.prototype.GetTriangleStripsFromMesh=function(a, b) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); return xc(c, a, b); }; g.prototype.GetTrianglesUInt16Array=g.prototype.GetTrianglesUInt16Array=function(a, b, d) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!yc(c, a, b, d); }; g.prototype.GetTrianglesUInt32Array=g.prototype.GetTrianglesUInt32Array=
function(a, b, d) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!zc(c, a, b, d); }; g.prototype.GetAttributeFloat=g.prototype.GetAttributeFloat=function(a, b, d) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!Ac(c, a, b, d); }; g.prototype.GetAttributeFloatForAllPoints=g.prototype.GetAttributeFloatForAllPoints=function(a, b, d)
{
const c=this.ptr; a&&'object'===typeof a&&
(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!Bc(c, a, b, d);
}; g.prototype.GetAttributeIntForAllPoints=g.prototype.GetAttributeIntForAllPoints=function(a, b, d) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!Cc(c, a, b, d); }; g.prototype.GetAttributeInt8ForAllPoints=g.prototype.GetAttributeInt8ForAllPoints=function(a, b, d)
{
const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&
(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!Dc(c, a, b, d);
}; g.prototype.GetAttributeUInt8ForAllPoints=g.prototype.GetAttributeUInt8ForAllPoints=function(a, b, d) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!Ec(c, a, b, d); }; g.prototype.GetAttributeInt16ForAllPoints=g.prototype.GetAttributeInt16ForAllPoints=function(a, b, d)
{
const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&
(d=d.ptr); return !!Fc(c, a, b, d);
}; g.prototype.GetAttributeUInt16ForAllPoints=g.prototype.GetAttributeUInt16ForAllPoints=function(a, b, d) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!Gc(c, a, b, d); }; g.prototype.GetAttributeInt32ForAllPoints=g.prototype.GetAttributeInt32ForAllPoints=function(a, b, d)
{
const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!Hc(c,
a, b, d);
}; g.prototype.GetAttributeUInt32ForAllPoints=g.prototype.GetAttributeUInt32ForAllPoints=function(a, b, d) { const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); return !!Ic(c, a, b, d); }; g.prototype.GetAttributeDataArrayForAllPoints=g.prototype.GetAttributeDataArrayForAllPoints=function(a, b, d, e, f)
{
const c=this.ptr; a&&'object'===typeof a&&(a=a.ptr); b&&'object'===typeof b&&(b=b.ptr); d&&'object'===typeof d&&(d=d.ptr); e&&'object'===typeof e&&
